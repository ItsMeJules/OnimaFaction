...
public class BardMenu extends PacketMenu implements PacketStaticMenu {
	...
	public void registerItems() {
		...
		buttons.put(13, new DisplayButton(new BetterItem(Material.FEATHER, 1, 0, "§a§lJump", Lists.newArrayList("", "§6Effets :", " §e» §2Jump Boost II §7pour §25 secondes §7(quand tenu)", " §e» §2Jump Boost V §7pour §210 secondes §7(quand cliqué)", "", "§3Cet item utilise §e20 §3de power quand cliqué."))));
		buttons.put(14, new DisplayButton(new BetterItem(Material.IRON_INGOT, 1, 0, "§7§lRésistance", Lists.newArrayList("", "§6Effets :", " §e» §2Resistance I §7pour §25 secondes §7(quand tenu)", " §e» §2Resistance II §7pour §25 secondes §7(quand cliqué)", "", "§3Cet item utilise §e25 §3de power quand cliqué."))));
