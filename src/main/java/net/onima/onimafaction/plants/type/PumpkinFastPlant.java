...
public class PumpkinFastPlant extends FastPlant {

	public PumpkinFastPlant(Location plantLocation) {
		super(PlantType.PUMPKIN, plantLocation, DEFAULT_HARVEST_TIME);
	}
	...
	public void initData() {
		...
		for (BlockFace face : new BlockFace[] {BlockFace.NORTH, BlockFace.EAST, BlockFace.SOUTH, BlockFace.WEST}) {
			if (block.getRelative(face).getType() == Material.PUMPKIN) {
