...
public class LivesGiveArgument extends BasicCommandArgument {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		sender.sendMessage("§dVous §7avez give §d" + amount + life + " à §d" + offlineFPlayer.getOfflineApiPlayer().getName() + "§7.");
			
		if (offlineFPlayer.getOfflineApiPlayer().isOnline())
			((APIPlayer) offlineFPlayer.getOfflineApiPlayer()).sendMessage("§d" + sender.getName() + " §7vous a give §d" + amount + life + "§7.");
